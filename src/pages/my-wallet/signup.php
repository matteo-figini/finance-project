...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $passwordrepeated = hash("sha512", $db_conn->real_escape_string($_POST["passwordrepeated"]));
    if ($password == $passwordrepeated) {
        ...
        if ($db_conn->query($sql) === TRUE) {
            ...
            $error = "Registrazione fallita. Cause probabili:<br>L'utente già esiste<br>Impossibile connettersi al DB.";
        }
    }
    else {
            ...
            <div class="w3-container" align="left">
                ...
                <div class="w3-container w3-row-padding w3-margin-bottom">
                    <form action="" method="post">
                        ...
                        <input type="password" name="passwordrepeated" required><br><br>
